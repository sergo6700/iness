...
function initMap() {
    var e = document.getElementById("map"), t = document.getElementById("map_api");
    if (null !== e) {
        if (null === t) {
        ...
        setTimeout(function () {
            try {
                var t = $("#map"), n = t.data("dsn-lat"), a = t.data("dsn-len"), i = t.data("dsn-zoom"),
                    o = new google.maps.LatLng(n, a), s = new google.maps.Map(e, {
                        center: {lat: n, lng: a},
                        zoom: i,
                        styles: [{
                            featureType: "all",
...
!function (e) {
    ...
    function t(r) {
        data_overlay(), function () {
        ...
        }(), SliderProject(), slick_client(a), function (s) {
            const r = "dsn-effect-animate", l = '[data-dsn-ajax="img"]';
            var d = !0;
            return {
                main_root: e("main.main-root"), ajax_click: e("a.effect-ajax "), isEffectAjax: function () {
                    ...
                    s && this.ajax_click.off("click"), this.ajax_click.on("click", function (a) {
                        if (!t.isEffectAjax()) {
                            a.preventDefault();
                            var i = e(this), o = i.attr("href"), s = i.data("dsn-ajax");
                    ...
                    let a = this, i = t.parents(".slide-content").data("dsn-id"),
                        o = e('.dsn-slider .slide-item[data-dsn-id="' + i + '"] .cover-bg').first(), s = n;
                    ...
                    let a = this, o = e(".nav-work-img-box img.dsn-active").first(), s = n;
                    ...
                    let n = this, a = e.parents(".next-project"), i = a.find(".bg-image").first(), o = t;
                    ...
                    let n = this, a = e.parents(".post-list-item").find(".bg").first(), i = t;
                    void 0 !== i && (TweenMax.to(a.find("img"), .8, {
                        ...
                        autoAlpha: 0, scale: .8, onComplete: function () {
                    ...
                    let a = this;
                    TweenMax.to(n, .8, {
                        scale: 1, height: "100%", top: 0, y: "0%", onComplete: function () {
                            a.createElement(n, t)
                        }
                    })
                }, createElement: function (a, o, s, d, c) {
                    let u = this, f = e('<div class="active-ajax-e"></div>');
                    f.css({
                        position: "fixed",
                        width: "100%",
                        height: "100%",
                    ...
                    TweenMax.to(f, 1, {
                        autoAlpha: 1, ease: Power4.easeInOut, onComplete: function () {
                            i.removeClass(r), u.loader(o, function (a, o, s) {
                                ...
                                void 0 === c && (c = {top: 0, left: 0}), g = .8, m = 1, TweenMax.to(h, 1, {
                                    top: c.top,
                                    left: c.left,
                                    width: d.width(),
                                    height: d.height(),
                                    ...
                                    onComplete: function () {
                                        TweenMax.to(f, m, {
                                            ...
                                            autoAlpha: 0, delay: g, onComplete: function () {
                                                f.remove()
                                            }
                                        })
                                    }
                    ...
                    let a = t.clone(), i = n[0].getBoundingClientRect();
                    return void 0 === i && (i = {left: 0, top: 0}), a.css({
                        position: "absolute",
                        display: "block",
                        transform: "",
                        transition: "",
                    ...
                    var o = this, s = e('<div class="class-ajax-loader"></div>');
                    s.css({
                        position: "fixed",
                        left: 0,
                        top: 0,
                    ...
                    a.scrollTop() < r && TweenMax.fromTo(this.main_root, 1, {y: 0}, {
                        y: -150,
                        ease: Expo.easeIn
                    }), TweenMax.to(s, 1, {
                        y: 0, ease: Expo.easeIn, onComplete: function () {
                            o.loader(t, function () {
                    ...
                    TweenMax.staggerTo(e(o.animateTextAjax), 1, {autoAlpha: 1, y: 0}, .2)
                }, loader: function (t, n) {
                    var a = this;
                    ...
                    TweenMax.fromTo(a, 1, {y: "0%"}, {
                        y: "-100%", ease: Expo.easeIn, onComplete: function () {
                            a.remove(), n.ajaxLoaderElemnt(), n.showAnimate()
                        }, delay: 1
                    }), t(!0)
                }, ajaxNext: function (t, n) {
                    var a = e('.dsn-imgs[data-dsn-next="blog"]'), i = this;
            ...
            t.justifiedGallery({rowHeight: 300, margins: 15}), t.magnificPopup({
                delegate: "a",
                type: "image",
                closeOnContentClick: !1,
                closeBtnInside: !1,
            ...
            const n = e(".nav-work-box").find(".work-item"), a = e(".nav-work-img-box");
            n.each(function (t) {
                let n = e(this);
            ...
            const t = e(".dsn-slider"), n = 1.2;
            return {
                initSlider: function () {
                    const n = t.find(".slide-item"), a = t.find(".dsn-slider-content");
                    n.each(function (t) {
                    ...
                    e.on("progress", function () {
                        ...
                        for (let t = 0; t < e.slides.length; t++) {
                            let n = e.slides[t].progress, a = .5 * e.width, i = n * a;
                    ...
                    a.on("slideChange", function () {
                        let o = t.find(".dsn-slider-content .dsn-active"), s = o.data("dsn-id");
                        ...
                        let c = t.find('.dsn-slider-content [data-dsn-id="' + r + '"]'),
                            u = c.find(".dsn-chars-wrapper"), f = s > r, h = new TimelineLite;
                    ...
                    return {
                        title: {autoAlpha: 1, x: "0%", scale: 1, rotation: 0, ease: Elastic.easeInOut, yoyo: !0},
    ...
    function n() {
        ...
        return {
            isMobile: function () {
                ...
                let i = .05;
                this.isMobiles() && (i = .02), t.init(n, {damping: i}), this.workScroll()
            }, sliderScroll: function () {
                t.init(document.querySelector(".slider .main-slider .slider-nav-list"), {damping: .05})
            }, menuScroll: function () {
                t.init(document.querySelector(".nav__content"), {damping: .05})
            }, commentScroll: function () {
                const e = document.querySelector(".comment-modal .comment-modal-container");
                null !== e && t.init(e, {damping: .05})
    ...
    !function () {
        var t = e(".preloader"), n = t.find(".preloader-block"), i = n.find(".percent"), o = n.find(".title"),
            s = n.find(".loading"), r = t.find(".preloader-bar"), l = r.find(".preloader-progress"),
            d = t.find(".preloader-after"), c = t.find(".preloader-before"),
            u = dsnGrid.pageLoad(0, 100, 300, function (e) {
                i.text(e), l.css("width", e + "%")
            });
        a.on("load", function () {
            clearInterval(u), TweenMax.fromTo(l, .5, {width: "95%"}, {
                width: "100%", onUpdate: function () {
                    var e = l.width() / l.parent().width() * 100;
                    i.text(parseInt(e, 10))
                }, onComplete: function () {
                    TweenMax.to(r, .5, {left: "100%"}), TweenMax.to(o, 1, {
                        autoAlpha: 0,
                        y: -100
                    }), TweenMax.to(s, 1, {
                        autoAlpha: 0,
                        y: 100
                    }), TweenMax.to(i, 1, {autoAlpha: 0}), TweenMax.to(c, 1, {
                        y: "-100%",
                        delay: .7
                    }), TweenMax.to(d, 1, {
        ...
        e(".site-header .custom-drop-down > a").on("click", function () {
            ...
            void 0 !== o && o.prepend(a), t.on("click", function () {
                ...
                t.preventDefault();
                var n = e(this).parent(), a = n.find("ul").css("display");
                e(".nav__list-dropdown").find("ul").slideUp("slow"), "block" !== a && n.find("ul").slideDown("slow")
            })
        }), a.on("scroll", function () {
            var t = a.scrollTop(), n = e(".site-header , .header-top"), i = e(".page-content").offset(), o = 70;
        ...
        if (!(n.length <= 0)) {
            var o = n.find(".text-button"), s = n.find(".text-open"), r = n.find(".text-close");
            dsnGrid.convertTextWord(o, o, !0), dsnGrid.convertTextWord(s, s, !0), dsnGrid.convertTextWord(r, r, !0)
        }
    }();
    var s = n(), r = function () {
        var t = new ScrollMagic.Controller;
        const n = '[data-dsn-header="project"]', o = '[data-dsn-footer="project"]';
        return {
            clearControl: function () {
                ...
                let a = e("#dsn-hero-parallax-img"), o = e("#dsn-hero-parallax-title"),
                    s = e("#dsn-hero-parallax-fill-title"), r = e("#descover-holder"), l = 1.2;
                ...
                let n = e("#dsn-next-parallax-img"), a = e("#dsn-next-parallax-title"),
                    r = !(n.length <= 0) && new ScrollMagic.Scene({
                        triggerElement: o,
                        triggerHook: 1,
                        duration: "100%"
                    }).setTween(TweenMax.to(n, 1, {force3D: !0, y: "30%", scale: 1}, 0)).addTo(t),
                ...
                e('[data-dsn-grid="move-up"]').each(function () {
                    ...
                    if (a.length > 0) {
                        ...
                        if (a.hasClass("has-top-bottom")) {
                            ...
                            r = TweenMax.to(a, .8, {force3D: !0, y: e, ease: Power0.easeNone})
                        } else {
                            ...
                            1 !== i ? (a.css("top", 0), r = TweenMax.to(a, 2, {
                                ...
                                scale: t,
                                y: e
                            })) : r = TweenMax.to(a, 1, {force3D: !0, scale: t, y: e, ease: Power0.easeNone})
                        }
                ...
                0 === t.length || a.width() < 992 || t.each(function () {
                    var t = e(this), n = (dsnGrid.removeAttr(t, "data-dsn"), dsnGrid.removeAttr(t, "data-dsn-speed")),
                        a = dsnGrid.removeAttr(t, "data-dsn-move"), i = !1;
                ...
                e('[data-dsn="color"]').each(function () {
                    ...
                    var r = new ScrollMagic.Scene({triggerElement: this, triggerHook: .05, duration: o}).addTo(t);
                    r.on("enter", function () {
                ...
                if (!(n.length <= 0 || a.width() < 992)) {
                    var i = new ScrollMagic.Scene({
                        ...
                        triggerHook: 0,
                        duration: "100%"
                    }).setTween(TweenMax.fromTo(n, 1, {width: "100%"}, {width: "80%"})).addTo(t);
                    s.getListener(function () {
                        i.refresh()
                    })
                }
